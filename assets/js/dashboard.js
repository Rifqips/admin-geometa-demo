(function($) {
  ...
  $(function() {
    if ($("#performanceLine").length) { 
      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Plan',
            data: [200, 200, 200, 200, 200, 200, 200, 200, 200, 210, 240, 280, 200],
          ...
          label: 'Aktual',
          data: [30, 150, 190, 250, 120, 150, 130, 200, 30, 150, 40, 95, 180],
    ...
    if ($("#performanceCoal").length) { 
      const ctx = document.getElementById('performanceCoal');
      var graphGradient = document.getElementById("performanceCoal").getContext('2d');
      var graphGradient2 = document.getElementById("performanceCoal").getContext('2d');
      var saleGradientBg = graphGradient.createLinearGradient(5, 0, 5, 100);
      saleGradientBg.addColorStop(0, 'rgba(26, 115, 232, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(26, 115, 232, 0.02)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
